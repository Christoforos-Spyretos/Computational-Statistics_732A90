...
F^{-1}(x)&= \left\{ 
                    \begin{array}{ll}
										\mu_{DE} - \frac{1}{\alpha}\ln(2-2x) , x \geq\frac{1}{2}   \\
										\\
										\mu_{DE} + \frac{1}{\alpha}\ln(2x), x <\frac{1}{2}
										\end{array}
									 \right. \\
&= \mu_{DE} - \frac{1}{2}sgn(x-\frac{1}{2})ln(1+sgn(x-\frac{1}{2})-sgn(x-\frac{1}{2})2x) \\
&= \mu_{DE} - \frac{1}{2}sgn(x-\frac{1}{2})ln(1-2|x-\frac{1}{2}|) \\
&= \mu_{DE} - \frac{1}{2}sgn(x-\frac{1}{2})ln(1-|2x-1|)
\end{aligned}
$$
...
We combine the inverse function of the double exponential distribution (Laplace) DE(0, 1) and the inverse CDF method of u~U(0,1).

$$
\begin{aligned}
F^{-1}(u) &= \mu_{DE} - \frac{1}{2}sgn(u-\frac{1}{2})ln(1-2|u-1|) \\
\end{aligned}
$$
